...
public class CustomizeExceptionHandler_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "life.majiang.community.advice.CustomizeExceptionHandler"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.PrintWriter", false, CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("java.lang.Throwable", false, CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("javax.servlet.http.HttpServletResponse", false, CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("org.springframework.ui.Model", false, CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CustomizeExceptionHandler_SSTest_scaffolding.class.getClassLoader()); 
