...
public class GithubUserStrategy_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "life.majiang.community.strategy.GithubUserStrategy"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("life.majiang.community.provider.GithubProvider", false, GithubUserStrategy_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.provider.UFileService", false, GithubUserStrategy_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.provider.dto.GithubUser", false, GithubUserStrategy_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(GithubUserStrategy_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GithubUserStrategy_SSTest_scaffolding.class.getClassLoader()); 
