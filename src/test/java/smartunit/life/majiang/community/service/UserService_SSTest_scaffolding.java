...
public class UserService_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "life.majiang.community.service.UserService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("life.majiang.community.mapper.UserMapper", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.model.User", false, UserService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }
