...
public class CommentService_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "life.majiang.community.service.CommentService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("life.majiang.community.mapper.CommentExtMapper", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.mapper.CommentMapper", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.mapper.NotificationMapper", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.mapper.QuestionMapper", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.mapper.UserMapper", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.model.Comment", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.model.Question", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.model.User", false, CommentService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(CommentService_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CommentService_SSTest_scaffolding.class.getClassLoader()); 
