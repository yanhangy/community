...
public class NotificationService_SSTest_scaffolding {
  ...
  public static void initSmartSuiteFramework() { 
    org.smartunit.runtime.RuntimeSettings.className = "life.majiang.community.service.NotificationService"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("life.majiang.community.mapper.NotificationMapper", false, NotificationService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.model.Notification", false, NotificationService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
    mock(Class.forName("life.majiang.community.model.User", false, NotificationService_SSTest_scaffolding.class.getClassLoader()), withSettings().stubOnly());
  }

  private static void initializeClasses() {
    org.smartunit.runtime.classhandling.ClassStateSupport.initializeClasses(NotificationService_SSTest_scaffolding.class.getClassLoader() , ""
    );
  } 

  private static void resetClasses() {
    org.smartunit.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NotificationService_SSTest_scaffolding.class.getClassLoader()); 
